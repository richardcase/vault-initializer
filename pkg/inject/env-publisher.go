...
func (p EnvironmentPublisher) PublishSecrets(config *model.Config, clientset *kubernetes.Clientset, deployment *v1beta1.Deployment, secrets map[string]string) error {
