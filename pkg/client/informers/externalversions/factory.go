...
import (
	...
	vaultinit "github.com/richardcase/vault-initializer/pkg/client/informers/externalversions/vaultinit"
...
type SharedInformerFactory interface {
	...
	Vaultinit() vaultinit.Interface
}

func (f *sharedInformerFactory) Vaultinit() vaultinit.Interface {
	return vaultinit.New(f, f.namespace, f.tweakListOptions)
}
